  ...
  async (req, res, next) => {
    try {
      ...
      user.paymentSettings = {
        ...
        preferredMethod:
          preferredMethod ??
          currentSettings.preferredMethod ??
          "upi",
        ...
        preferredCardName:
          preferredCardName ??
          currentSettings.preferredCardName ??
          "",

        allowCOD:
          allowCOD ??
          currentSettings.allowCOD ??
          true,

        savePaymentHistory:
          savePaymentHistory ??
          currentSettings.savePaymentHistory ??
          true,

        paymentNotifications:
          paymentNotifications ??
          currentSettings.paymentNotifications ??
          true,
      };
