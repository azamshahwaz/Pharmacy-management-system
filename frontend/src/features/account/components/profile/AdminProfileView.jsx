  ...
  return (
    <div className="min-h-screen bg-[#f4f7f6] space-y-8 pb-10">
      ...
      <div className="bg-white rounded-[32px] p-8 border border-gray-100 shadow-sm">
        ...
        <SectionHeading
          title="Admin Details"
          subtitle="Overview of admin account information"
        />
      ...
      <div className="bg-white rounded-[32px] p-8 border border-gray-100 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <RoleInfoItem
            title="Access Level"
            value={user?.accessLevel || "Full Access"}
          ...
          <RoleInfoItem
            ...
            value={
              Array.isArray(user?.permissions)
                ...
                : user?.permissions || "Manage all aspects of the system"
            }
